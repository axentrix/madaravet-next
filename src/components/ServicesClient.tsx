    ...
    <div className="services-page">
      ...
      <section className="services-title">
        <h1 className="title-text">
          <span className="title-blue">Мадара вет</span>
          {' '}
          <span className="title-red">УСЛУГ��</span>
        </h1>
      </section>
      ...
      <section className="services-description">
        <div className="description-container">
          <div className="description-text">
            Ние сме модерен ветеринарен кабин��т в самия център на София и предлагаме цялостна гама висококачествени услуги за вашия домашен любимец. Основната дейност на нашия кабинет е лечение и профилактика на болестите при кучетата, котките, гризачите и другите домашни животни.
            <br /><br />
            Екипът ни с радост ще ви консултира както при избора на нов домашен любиме��, така и след неговото придобиване. Изготвяме индивидуални планове за хранене, обезпаразитяване и ваксинация на нашите пациенти. Наред с адекватна профилактика и лечение на д��машните животни, Мадара Вет предлага широка гама диагностични изследвания и тестове, както и редица хирургични интервенции и стационарно лечение в рамките на деня.
            <br /><br />
            Също така ние можем да се погрижим и за красивия външен вид на вашият любимец: кабинетът предлага разнообразни фризьорски услуги за кучета и котки и стоматологични процедури за зъбен камък.
            <br /><br />
            Ние, екипът на Мадара Вет, ви очакваме!
          </div>
        </div>
      </section>
        ...
        <div className="cards-wrapper">
          ...
          <div className="service-circles">
            ...
            <div className="service-circle service-circle-pink">
              ...
              <h3 className="circle-title circle-title-right">
                индивидуално насочена профилактика
              </h3>
            </div>
          </div>
        </div>
