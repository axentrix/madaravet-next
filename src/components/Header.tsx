    ...
    >
      <div className="header-inner max-w-screen-xl mx-auto mt-4" suppressHydrationWarning>
        <div className={`header-card bg-white rounded-[24px] py-4 px-4 flex justify-between items-center transition-shadow duration-300 ${hasScrolled ? 'shadow-md' : ''}`} suppressHydrationWarning={true}>
          <Link href="/" aria-label="Home" className="header-logo-wrapper flex items-start gap-2" suppressHydrationWarning>
            ...
            <div className="header-logo-text flex flex-col justify-center items-center">
              ...
              <div className="header-logo-subtitle text-[#1872D9] text-[15px] leading-none font-sansation">Д-р Юлиана Соколова</div>
            </div>
          </Link>

          <nav className="desktop-menu hidden lg:flex items-center gap-6 px-8 py-6 rounded-[24px]" suppressHydrationWarning>
            <Link href="/about" className="menu-item text-[#182559] text-[14px] font-bold leading-6 hover:text-[#1872D9] transition-colors font-raleway">
              <span suppressHydrationWarning data-i18n="nav_about">За нас</span>
            </Link>
            <Link href="/services" className="menu-item text-[#182559] text-[14px] font-bold leading-6 hover:text-[#1872D9] transition-colors font-raleway">
            ...
            <Link href="/contact" className="menu-item text-[#182559] text-[14px] font-bold leading-6 hover:text-[#1872D9] transition-colors font-raleway">
